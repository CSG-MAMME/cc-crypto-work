...
\begin{figure}[h!]
    ...
    \begin{tikzpicture}
        ...
        % Table of queries 
        \draw[color=red] (7.25, -5.75) -- (8.75, -5.75) node[midway, text=red, anchor=south] {\scriptsize Answered Queries};
        \draw[color=red] (8.05, -5.75) -- (8.05, -6.85);
        \node[text=red] at (8, -6) {$m_1 \hspace{5pt} \sigma_1'$};
        \node[text=red] at (8, -6.5) {$ \vdots \hspace{12pt} \vdots$};
